...
<html>
  <head>
    <title>NDKC EMERGENCY BUTTON</title>
    ...
    <style>
      ...
      h4 {font-size: 0.8rem;}
      body {margin: 0;}
      .topnav {overflow: hidden; background-color: #1d5d20; color: white; font-size: 1.2rem;}
      .content {padding: 5px; }
      .card {background-color: white; box-shadow: 0px 0px 10px 1px rgba(140,140,140,.5); border: 1px solid #1d5d20; border-radius: 15px;}
      .card.header {background-color: #1d5d20; color: white; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; border-top-right-radius: 12px; border-top-left-radius: 12px;}
      ...
      <div class="cards">
        ...
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">BUTTON 1</h3>
          </div>
          ...
          <div style="position:relative;">
            <div style="position:relative; float: left;top: 3px;width: 47%;left: 0px;text-align: right;">
              <span class="LEDColor" style="font-weight:bold;">BUZZER : </span>
            </div>
            ...
            <div style="position:relative;float: right; width: 51%;right: 0px; top: 5px;">
              <div style="position:relative; float: left;">
                <label class="switch">
                  <input type="checkbox" id="togLED_2_Slave_1" onclick="send_LED_State('togLED_2_Slave_1','S1','1')">
          ...
          <p class="statusreadColor"><span>BUTTON 1 : </span><span id="LED_1_State_Slave_1"></span></p>
        ...
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">BUTTON 2</h3>
          </div>
          ...
          <p class="statusreadColor"><span>BUTTON 2 : </span><span id="LED_1_State_Slave_2"></span></p>
          
          <!-- *********************************************************************** -->
        </div>  
        <!-- ======================================================================================================= -->
        
        <!-- == ESP32 Slave 3 Monitoring And Controlling =========================================================== -->
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1.2rem;">BUTTON 3</h3>
          </div>
          ...
          <p class="statusreadColor"><span>BUTTON 3 : </span><span id="LED_1_State_Slave_3"></span></p>
      ...
      if (!!window.EventSource) {
        ...
        source.addEventListener('allDataJSON', function(e) {
          ...
          if (obj.ID_Slave == "S3") {
              ...
              // Update temperature reading with two decimal points
              ...
              // Update last time data received
